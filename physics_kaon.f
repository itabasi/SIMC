...
* 'f' and 'fer' indicate fermi momenta. 'star' or 'cm' indicate CM system
	...
	main%wcm = sqrt(s) 
!	write(6,*)'efer,pfer,s',efer,pfer,s
...
*	  write(6,*) 'targ%Mrec_struck : ',targ%Mrec_struck
...
!	  write(6,*) 'Kaon C.M. momentum passed to sig_factorized does not agree with' ! test by ita
...
!       not working checked by itabashi
