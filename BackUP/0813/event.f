...
!       mporb is ingegral (he3.data) value of momentum 
     ...
     >        .or.doing_deutrho .or.doing_deutsemi) then !Em = binding energy
	  ...
	  if (doing_hepi .or. doing_hekaon .or. doing_hedelta .or. doing_herho) then
	    ...
	    efer = targ%M - sqrt(m_spec**2+pfer**2)
!	    write(6,*)'efer, Em ',efer,vertex%Em
...
!---------------------------------------------------------------------
	...
	real*8 W2
	real*8 oop_x,oop_y
	real*8 mm,mmA,mm2,mmA2
	real*8 t,mm_L,mm_nnL,mm_nnL2,mm_L2,mm_S2,mm_S
...
!	   write(6,*)'survivalprob, doing_decay,sigcc',survivalprob,doing_decay,main%sigcc
	   main%sigcc_recon = 1.0
