...
! ... read the dbase file.
	...
	write(6,*) '*         Last edited on: 05/24/2018           *'
	write(6,*) '*                                              *'
	write(6,*) '************************************************'
...
!       if (targ%can.ne.1 .and. targ%can.ne.2) stop 'bad targ.can value'
	  if (targ%can.ne.1 .and. targ%can.ne.2 .and. targ%can.ne.3 .and. targ%can.ne.4) stop 'bad targ.can value'
	endif
...
4005	  format(6e12.4)
     ...
     1			zsrff5(iread,iq2,iang),zsiff5(iread,iq2,iag),
