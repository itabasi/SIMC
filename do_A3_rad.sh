mv infiles/Tritium/3He_fast_1mC_rad_benhar_bound.data infiles/current.data
./simc << EOF
current.data
EOF
...
# ----------------
mv infiles/Tritium/3He_fast_1mC_rad_benhar_cont.data infiles/current.data
./simc << EOF
current.data
EOF
python python/make_root_one_default.py
...
# ----------------
mv infiles/Tritium/3H_fast_1mC_rad_benhar_cont.data infiles/current.data
./simc << EOF
current.data
EOF
python python/make_root_one_default.py
